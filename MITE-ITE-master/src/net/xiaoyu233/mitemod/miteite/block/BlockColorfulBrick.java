...
public class BlockColorfulBrick extends Blocks implements IBlockWithSubtypes {
...
//        this.setMinHarvestLevel(0);
    ...
    public void a(mt par1IconRegister) {
        this.subtypes.setIcons(this.registerIcons(par1IconRegister, this.getTextures(), "colorful_brick/colorful_brick_"));
    }
